...
def test_simple_division_subtraction(
    formula_evaluator: tuple[FormulaEvaluator, dict[str, pd.DataFrame]],
) -> None:
...
def test_complex_nested_division(
    formula_evaluator: tuple[FormulaEvaluator, dict[str, pd.DataFrame]],
) -> None:
...
def test_exponentiation_subtraction(
    formula_evaluator: tuple[FormulaEvaluator, dict[str, pd.DataFrame]],
) -> None:
...
def test_division_by_diagonal_matrix(
    formula_evaluator: tuple[FormulaEvaluator, dict[str, pd.DataFrame]],
) -> None:
...
def test_division_by_near_diagonal_matrix(
    formula_evaluator: tuple[FormulaEvaluator, dict[str, pd.DataFrame]],
) -> None:
...
def test_matrix_with_nan_values(
    formula_evaluator: tuple[FormulaEvaluator, dict[str, pd.DataFrame]],
) -> None:
...
def test_division_by_sparse_matrix(
    formula_evaluator: tuple[FormulaEvaluator, dict[str, pd.DataFrame]],
) -> None:
...
def test_complex_operation_with_diagonal_matrix(
    formula_evaluator: tuple[FormulaEvaluator, dict[str, pd.DataFrame]],
) -> None:
...
def test_inverting_diagonal_matrix(
    formula_evaluator: tuple[FormulaEvaluator, dict[str, pd.DataFrame]],
) -> None:
