...
def test_simple_division_subtraction(formula_evaluator):
...
def test_complex_nested_division(formula_evaluator):
...
def test_exponentiation_multiplication(formula_evaluator):
...
def test_exponentiation_subtraction(formula_evaluator):
...
def test_zero_division(formula_evaluator):
...
def test_add_dataframes(formula_evaluator):
...
def test_division_by_diagonal_matrix(formula_evaluator):
...
def test_division_by_near_diagonal_matrix(formula_evaluator):
...
def test_matrix_with_nan_values(formula_evaluator):
...
def test_division_by_sparse_matrix(formula_evaluator):
...
def test_complex_operation_with_diagonal_matrix(formula_evaluator):
...
def test_inverting_diagonal_matrix(formula_evaluator):
...
def test_nan_handling(formula_evaluator):
